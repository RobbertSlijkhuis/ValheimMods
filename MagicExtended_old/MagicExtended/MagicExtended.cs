...
namespace MagicExtended
{
    ...
    internal class MagicExtended : BaseUnityPlugin
    {
        ...
        private void AddEarthStaff()
        {
            ...
            staffConfig.AddRequirement(new RequirementConfig("Eitr", 15, 3));
            ItemDrop itemDrop = StaffMetalEarthPrefab.GetComponent<ItemDrop>();
            itemDrop.m_itemData.m_shared.m_attackForce = 100;
            itemDrop.m_itemData.m_shared.m_damages.m_blunt = 150;
            itemDrop.m_itemData.m_shared.m_damages.m_blunt = 20;
            itemDrop.m_itemData.m_shared.m_attack.m_staggerMultiplier = 2;
